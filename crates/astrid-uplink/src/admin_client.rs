...
pub const fn topic_suffix(req: &AdminRequestKind) -> &'static str {
    match req {
        ...
        AdminRequestKind::StationLockGet { .. } => "station.lock.get",
        AdminRequestKind::StationLockSet { .. } => "station.lock.set",
        AdminRequestKind::StationLockDelete { .. } => "station.lock.delete",
