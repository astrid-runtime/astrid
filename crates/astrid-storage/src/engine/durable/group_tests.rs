...
struct RecordingProjectionObserver {
    phases: Mutex<BTreeSet<crate::engine::ProjectionPhase>>,
}

impl crate::engine::ProjectionObserver for RecordingProjectionObserver {
    fn record(&self, phase: crate::engine::ProjectionPhase, _elapsed: Duration) {
...
impl crate::engine::ProjectionObserver for ReentrantProjectionObserver {
    fn record(&self, _phase: crate::engine::ProjectionPhase, _elapsed: Duration) {
...
fn observed_staging_and_publication_report_the_durable_phases() {
    ...
    for expected in [
        crate::engine::ProjectionPhase::ObjectPreparation,
        crate::engine::ProjectionPhase::AdmissionProbe,
        crate::engine::ProjectionPhase::ArenaAppend,
        crate::engine::ProjectionPhase::PhysicalMapUpdate,
        crate::engine::ProjectionPhase::ClosureValidation,
        crate::engine::ProjectionPhase::RootPublication,
        crate::engine::ProjectionPhase::Flush,
    ] {
...
fn prepared_projection_batches_are_bound_to_the_preparing_engine() {
    ...
    let prepared =
        crate::engine::PrincipalProjectionEngine::<String>::prepare_objects(&first, records)
            .unwrap();
    let error = crate::engine::PrincipalProjectionEngine::<String>::stage_prepared_objects(
        &second, prepared,
    )
    .unwrap_err();
