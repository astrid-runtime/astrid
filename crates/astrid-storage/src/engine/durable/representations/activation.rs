...
pub(super) struct InitialState {
    ...
    pub(super) active: crate::storage_model::RepresentationStateId,
}
...
impl MapNodeRef for (&crate::storage_model::PhysicalMapNodeId, &PhysicalMapNode) {
    fn node(&self) -> &PhysicalMapNode {
        self.1
    }
}
