...
| Fleet computer | Multi-user home-fleet tenancy, shared computer and browser authority, composed fleet roots plus principal overlays, human mounts, desktop leases, and team service boundary | Fleet-owned root grammar, provider-neutral namespace core, two-user/two-agent browser/desktop/mount proof, cross-platform adapters, separate Linux Realm conformance |
