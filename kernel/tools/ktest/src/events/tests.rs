...
fn passing_serial_with(kernel: &str, sysgen: &str, kfloor: u64, sfloor: u64) -> String {
    ...
    ev("\"ev\":\"domain.reclaim\",\"id\":1,\"generation\":10,\"expected\":22,\"freed\":22,\"swept\":22,\"blocked\":0".into());
    ev("\"ev\":\"domain.stop.admission-released\",\"id\":1,\"generation\":10,\"ok\":true".into());
