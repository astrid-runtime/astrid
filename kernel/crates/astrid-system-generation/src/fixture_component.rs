...
pub const EMULATOR_COMPONENT_CODE_LEN: usize = 66;
pub const EMULATOR_COMPONENT_LEN: usize =
    EMULATOR_COMPONENT_HEADER_LEN + EMULATOR_COMPONENT_CODE_LEN;

const _: () = assert!(EMULATOR_COMPONENT_LEN == 130);

/// Scenario values match the harness: exit, page fault, quota, and a hostile
/// probe of the page adjacent to this domain's private probe.
const MACHINE_CODE: [u8; EMULATOR_COMPONENT_CODE_LEN] = [
    0x83, 0xff, 0x00, 0x74, 0x1f, 0x83, 0xff, 0x01, 0x74, 0x10, 0x83, 0xff, 0x02, 0x74, 0x05, 0x83,
    0xff, 0x03, 0x74, 0x12, 0xf3, 0x90, 0xeb, 0xfc, 0x0f, 0x0b, 0x31, 0xc0, 0x3e, 0x89, 0x04, 0x25,
    0x00, 0x00, 0x00, 0x00, 0xcc, 0xcc, 0x48, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x80, 0x32, 0x00, 0x00,
    0x48, 0x05, 0x00, 0x10, 0x00, 0x00, 0xc7, 0x00, 0x00, 0x00, 0x00, 0x00, 0xcc, 0x31, 0xc0, 0xcc,
    0x0f, 0x0b,
];
